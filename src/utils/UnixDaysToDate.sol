...
contract UnixDaysToDate {
    ...
    /**
     * Uses Fliegel and van Flandern algorithm for converting from days to date
     */
    function _daysToDate(uint64 _days) internal pure returns(uint256 _year, uint256 _month, uint256 _day) {
        unchecked {
            uint256 L = _days + 68569 + 2440588; // Convert to march 1 4900 BCE
            ...
            _year = 100 * (N - 49) + _year + L; // translate from 4900 BCE frame to CE frame
        }
    }
}